...
import { toLatin, slug, key } from '@kviz/build/serbian'
import { setApp, overpass, query, APP } from '@kviz/build/sources'
import { writeData } from '@kviz/build/geo'
...
const okruzi = JSON.parse(readFileSync(resolve(APP, 'data/okruzi.json'), 'utf8'))
