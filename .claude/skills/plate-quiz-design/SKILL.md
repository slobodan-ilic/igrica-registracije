---
name: plate-quiz-design
description: The house visual language for the plate-quiz app. Load before changing any CSS, adding a screen or component, or styling a new country, so the look stays one product instead of drifting back to generic defaults.
---
